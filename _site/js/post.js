$(document).ready(function(){
    ...
    //***********************
    //**评论
    window.disqus_shortname = 'leonhome'; // required: replace example with your forum shortname
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('raining0822.github.io')>-1 ){
